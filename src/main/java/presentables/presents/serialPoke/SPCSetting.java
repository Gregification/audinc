...
public enum SPCSetting {
		...
		TIMEOUT_WRITE				(Integer.class, true ,		"time out in miliseconds before a write attempt is givenup. Note : only avaliable on windows systems, will have no effect otherwise"),
		TIMEOUT_MODE				(timeoutOptions.class , 	false,		"", (Object[])(timeoutOptions.values())),
